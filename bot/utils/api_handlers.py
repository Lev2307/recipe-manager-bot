...
async def fetch_recipes_by_ingredients(ingredients: list, user_search_offset: int, recipes_number=2):
...
async def fetch_recipes_by_cuisine(cuisine_type: str, user_search_offset: int, recipes_number=2):
